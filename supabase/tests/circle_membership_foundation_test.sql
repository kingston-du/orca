...
select policies_are('public', 'circles', array['circles_select_member']::name[], 'circles has only the member-read policy');
...
select policies_are('public', 'circle_invites', array['circle_invites_select_admin']::name[], 'circle_invites has only the admin-read policy');
