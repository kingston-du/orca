...
After each completed coherent checkpoint, add or update a numbered lesson in `docs/course/` and its index. Keep it concise and teach:

- the end-to-end flow;
- the few most important lines of real Orca code;
...
Do not paste entire implementation files into a lesson. Link to the source and explain why the important lines exist.
