...
> **Archived historical design — do not implement.** Circle deletion and its admin/member hierarchy are outside friend-first V1 and do not match the deliberately simpler possible V1.1 Group model. Preserve this only as a distributed-cleanup case study. See [`PROJECT.md`](../../../PROJECT.md).
