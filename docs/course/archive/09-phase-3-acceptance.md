...
> **Archived historical acceptance record.** This proves the former Circle phase and is not a current product checkpoint. Safe link parsing, deliberate consent, and server-side authorization remain transferable review ideas. See [`PROJECT.md`](../../../PROJECT.md).
