...
> **Archived Circle-era lesson.** The token, transaction, idempotency, and locking concepts remain valuable, but the Circle invitation, membership-role, and final-admin product contract is obsolete. Do not implement this schema for friend-first Orca. See [`PROJECT.md`](../../../PROJECT.md).
