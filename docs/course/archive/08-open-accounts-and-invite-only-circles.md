...
> **Archived Circle-era lesson.** The separation between authentication and private-data authorization remains current, but invite-only Circles are not the friend-first social model. Do not implement its Circle schema or screens. See [`PROJECT.md`](../../../PROJECT.md).
...
## The historical end-to-end flow
