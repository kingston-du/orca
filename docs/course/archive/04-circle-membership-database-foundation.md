...
> **Archived Circle-era lesson.** This design is conceptually useful but tied to Orca's obsolete Circle model. Use it to study grants, RLS, transactional RPCs, and invariants—not as the current product or schema contract. See [`PROJECT.md`](../../../PROJECT.md).
